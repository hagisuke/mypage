...
AFRAME.registerComponent('info-message', {
  ...
  update: function () {
    ...
    messageEl.innerHTML = "<p>This is a simple example of playing the video. Please note that there may be no sound on smartphone browsers due to regulations.</p>";
